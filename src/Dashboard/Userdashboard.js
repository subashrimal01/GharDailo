...
function UserDashboard() {
  ...
  const UserUpdate = (user_id) => {
    axios.get("https://ghardailo.herokuapp.com/user/" + user_id)
      .then((res) => {
  ...
  const deleteuser = (pro_idd) => {
    axios.delete("https://ghardailo.herokuapp.com/deleteuser/" + pro_idd)
      .then()
      .catch()
          ...
          <nav className="sidebar sidebar-offcanvas" id="sidebar">
            <ul className="nav">
              ...
              <li className="nav-item sidebar-actions">
                <a href="/addroom"><span className="side-menu nav-link">
                      ...
                      <div className="card-body">
                        ...
                        <table className="table col-12">
                          <thead className="thead-dark">
                            <tr>
                              <th style={{ fontSize: "14px" }} scope="col">Full Name</th>
                              <th style={{ fontSize: "14px" }} scope="col">Email</th>
                              <th style={{ fontSize: "14px" }} scope="col">Age</th>
                              ...
                              return (
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td style={{ fontSize: "14px" }}>{user.full_name}
                                    </td>
                                    <td style={{ fontSize: "14px" }}>{user.email}</td>
                                    <td style={{ fontSize: "14px" }}>{user.age}</td>


                                    <button style={{ fontSize: "14px" }} onClick={e => { UserUpdate(user._id) }} className="btn btn-success bg-success m-4">Update</button>
                                    <button style={{ fontSize: "14px" }} onClick={e => { deleteuser(user._id) }} className="btn-danger bg-danger">Delete</button>
                                  </tr>
